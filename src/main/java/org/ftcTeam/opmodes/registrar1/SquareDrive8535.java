...
import static org.ftcTeam.configurations.Team7394.newConfig;
...
@Autonomous
public class SquareDrive8535 extends ActiveOpMode {

    private Team7394 robot = newConfig(hardwareMap, getTelemetryUtil());
    private MotorToTime motorToTime = new MotorToTime("motor with timer" , this ,robot.motor1 );
