/*boolean targetReached = false;
        //drive forward at 1 power until 10000 encoder position
...
public class AutonomousBlue extends ActiveOpMode {
    ...
    protected void onInit() {
        ...
        colorSensorComponent1 = new ColorSensorComponent(this, robot.color1, ColorSensorComponent.ColorSensorDevice.MODERN_ROBOTICS_I2C);
        colorSensorComponent2 = new ColorSensorComponent(this, robot.color2, ColorSensorComponent.ColorSensorDevice.MODERN_ROBOTICS_I2C);
    ...
    protected void activeLoop() throws InterruptedException {
        ...
        sleep(500);
            firstBeaconIsTeamColor = colorSensorComponent0.isBlue(10, 10, 10) || colorSensorComponent1.isBlue(10, 10, 10) || colorSensorComponent2.isBlue(10, 10, 10);
            ...
            telemetry.addData("state3 IsBlue: ", firstBeaconIsTeamColor);
            telemetry.update();
            ...
            if (targetReached) {
                ...
                boolean sensorIsBlue = colorSensorComponent1.isBlue(10, 10, 10) || colorSensorComponent2.isBlue(10, 10, 10) || colorSensorComponent0.isBlue(10, 10, 10);
                if (sensorIsBlue) {
                    state9Correct = true;
                } else {
                ...
                telemetry.addData("state3 IsBlue: ", sensorIsBlue);
                telemetry.update();
            }
